...
void Vector_writet(char * filename, Vector v) // write to a text file 
{
  FILE * fptr;
...
Vector Vector_readt(char * filename) // read from a text file 
{
...
void Vector_writeb(char * filename, Vector v) // write to a binary file 
{
  FILE * fptr;
...
Vector Vector_readb(char * filename) // read from a binary file 
{
  FILE * fptr;
